...
const DATA = {
  "Aplikasi Premium": {
    ...
    unit: "bulan",
    services: {
      "Canva": { icon: "icon/canva.png", prices: { 1: 2000, 2: 4000, 3: 6000 } },
      "Capcut": { icon: "icon/capcut.png", prices: { 1: 37000, 2: 74000, 3: 111000 } },
      "Alight Motion": { icon: "icon/am.png", prices: { 12: 5000 } },
      "YouTube": { icon: "icon/yt.png", prices: { 1: 5000, 2: 10000, 3: 15000 } },
      "Netflix": { icon: "icon/netflix.png", prices: { 1: 33000 } },
  ...
  "Suntik Instagram": {
    icon: "icon/ig.png",
    services: {
      "Followers": { 1000: 15000, 2000: 25000, 3000: 40000, 4000: 50000, 5000: 65000, 6000: 75000, 7000: 95000, 8000: 105000, 9000: 120000, 10000: 135000 },
...
ratingNoBtn.addEventListener("click", () => {
  showToast("Tombol rusak, pilih tombol samping-nya aja.", "#E5484D");
});
